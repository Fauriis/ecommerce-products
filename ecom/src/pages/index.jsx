    ...
    <>
      ...
      <Layout>
        ...
        <section className="text-center py-6 lg:block hidden">
          ...
          <div class="relative left-44 ml-96 max-w-sm rounded-lg bg-white p-8 shadow-lg dark:bg-neutral-700">
            <form>
              ...
              <button
                type="submit"
                class="w-full rounded bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-black shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
                data-te-ripple-init
